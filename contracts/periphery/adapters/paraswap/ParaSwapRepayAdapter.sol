...
contract ParaSwapRepayAdapter is BaseParaSwapBuyAdapter, ReentrancyGuard {
   ...
   * The user should give this contract allowance to pull the MTokens in order to withdraw the underlying asset, swap it
   ...
   * The user should give this contract allowance to pull the MTokens in order to withdraw the underlying asset
  ...
  function swapAndRepay(
    ...
    // Pull mTokens from user
    _pullMTokenAndWithdraw(address(collateralAsset), msg.sender, collateralAmount, permitSignature);

...
/// @title PancakeswapV2MCV2Worker02DisableLiquidation is a worker for force closing positions on low liquidity pools to prevent bad debt from price impact.
contract PancakeswapV2MCV2Worker02DisableLiquidation is OwnableUpgradeable, ReentrancyGuardUpgradeable, IWorker02 {
  /// @notice Libraries
  ...
  /// @dev Disabled liquidation. This should be used when force closing positions in low liquidity pools.
  function liquidate(
    uint256 /* id */
  ) external override onlyOperator nonReentrant {
    revert("!liquidate");
